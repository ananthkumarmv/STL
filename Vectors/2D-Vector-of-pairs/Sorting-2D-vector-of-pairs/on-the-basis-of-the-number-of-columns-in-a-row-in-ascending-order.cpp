...
int main(){
	...
	vector<pair<int, int>> vect1 = {{2, 1}, {4, 3}, {8, 1}};
	
	vector<pair<int, int> > vect2 = {{19, 10}, {11, 2}, {12, 14}, {14, 6}, {16, 18}};
	
	vector<pair<int, int> > vect3 = {{17, 18}, {19, 20}};
	
	vector<pair<int, int> > vect4 = {{7, 2}};
